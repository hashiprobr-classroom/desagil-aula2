...
class PrimoTest {
	...
	@Test
	void devolve1SeRecebe2() {
		assertEquals(1, p.conta(2));
	}

	@Test
	void devolve2SeRecebe3() {
		assertEquals(2, p.conta(3));
	}

	@Test
	void devolve2SeRecebe4() {
		assertEquals(2, p.conta(4));
	}

	@Test
	void devolve3SeRecebe5() {
		assertEquals(3, p.conta(5));
	}

	@Test
	void devolve3SeRecebe6() {
		assertEquals(3, p.conta(6));
	}

	@Test
	void devolve4SeRecebe7() {
		assertEquals(4, p.conta(7));
	}

	@Test
	void devolve4SeRecebe8() {
		assertEquals(4, p.conta(8));
	}

	@Test
	void devolve4SeRecebe9() {
		assertEquals(4, p.conta(9));
	}

	@Test
	void devolve4SeRecebe10() {
		assertEquals(4, p.conta(10));
	}

	@Test
	void devolve5SeRecebe11() {
		assertEquals(5, p.conta(11));
	}

	@Test
	void devolve5SeRecebe12() {
		assertEquals(5, p.conta(12));
	}

	@Test
	void devolve6SeRecebe13() {
